...
!function(n, r) {
    ...
    function on(n, r, t, e) {
        ...
        if (n != n)
            return r != r;
        var i = typeof n;
        return ("function" === i || "object" === i || "object" == typeof r) && function n(r, t, e, i) {
    ...
    function yr(n, r, t) {
        return function(e, u, i) {
            ...
            if (u != u)
                return (i = r(o.call(e, a, f), $)) >= 0 ? i + a : -1;
    ...
    var Zr = Yr({
        ...
        template: function(n, r, t) {
            ...
            n.replace(e, (function(r, t, e, o, a) {
                return i += n.slice(u, a).replace(Hn, Qn),
                u = a + r.length,
        ...
        memoize: function(n, r) {
            var t = function(e) {
                ...
                return W(u, i) || (u[i] = n.apply(this, arguments)),
                u[i]
            };
            return t.cache = {},
            t
        ...
        throttle: function(n, r, t) {
            ...
            var f = function() {
              ...
              , c = function() {
                ...
                a = c,
                o = n.apply(u, i),
                e || (u = i = null)) : e || !1 === t.trailing || (e = setTimeout(f, l)),
                o
            };
...
!function(e) {
    ...
    return e.widget("ui.accordion", {
        ...
        _createIcons: function() {
            ...
            a && (t = e("<span>"),
            this._addClass(t, "ui-accordion-header-icon", "ui-icon " + a.header),
            t.prependTo(this.headers),
            i = this.active.children(".ui-accordion-header-icon"),
            this._removeClass(i, a.header)._addClass(i, null, a.activeHeader)._addClass(this.headers, "ui-accordion-icons"))
        },
        ...
        _refresh: function() {
            var t, i = this.options, a = i.heightStyle, s = this.element.parent();
        ...
        _eventHandler: function(t) {
            var i, a, s = this.options, n = this.active, h = e(t.currentTarget), r = h[0] === n[0], o = r && s.collapsible, d = o ? e() : h.next(), c = n.next(), l = {
                oldHeader: n,
                oldPanel: c,
                newHeader: o ? e() : h,
                newPanel: d
            ...
            t.preventDefault(),
            r && !s.collapsible || !1 === this._trigger("beforeActivate", t, l) || (s.active = !o && this.headers.index(h),
            this.active = r ? e() : h,
            this._toggle(l),
            this._removeClass(n, "ui-accordion-header-active", "ui-state-active"),
            s.icons && (i = n.children(".ui-accordion-header-icon"),
            this._removeClass(i, null, s.icons.activeHeader)._addClass(i, null, s.icons.header)),
            r || (this._removeClass(h, "ui-accordion-header-collapsed")._addClass(h, "ui-accordion-header-active", "ui-state-active"),
            s.icons && (a = h.children(".ui-accordion-header-icon"),
            this._removeClass(a, null, s.icons.header)._addClass(a, null, s.icons.activeHeader)),
        ...
        _toggle: function(t) {
            ...
            this.prevShow = i,
            this.prevHide = a,
            this.options.animate ? this._animate(i, a, t) : (a.hide(),
            i.show(),
        ...
        _animate: function(e, t, i) {
            var a, s, n, h = this, r = 0, o = e.css("box-sizing"), d = e.length && (!t.length || e.index() < t.index()), c = this.options.animate || {}, l = d && c.down || c, u = function() {
                h._toggleComplete(i)
            };
            return "number" == typeof l && (n = l),
            "string" == typeof l && (s = l),
            s = s || l.easing || c.easing,
            n = n || l.duration || c.duration,
            ...
            void e.hide().animate(this.showProps, {
                ...
                step: function(e, i) {
                    i.now = Math.round(e),
                    "height" !== i.prop ? "content-box" === o && (r += i.now) : "content" !== h.options.heightStyle && (i.now = Math.round(a - t.outerHeight() - r),
                    r = 0)
                }
...
(function($, Drupal, drupalSettings) {
    ...
    Drupal.behaviors.accordionMenus = {
        attach: function(context, settings) {
            ...
            $('.accordion_menus_block_container').accordion({
                header: 'h2.accordion-title',
                heightStyle: 'content'
            });
            $.each(closedByDefault, function(i, val) {
                $('.accordion_menus_block_container.' + val).accordion({
                    collapsible: true,
                    active: false
                });
            });
